            ...
            <footer>
                <div className="footer">
                    <div className="footer__location">
                        ...
                        <a href="tel:+19172272842" className="footer__phone">1-917-227-2842</a>
                        <a href="mailto:uroboros-tattoo@gmail.com" className="footer__mail">uroboros-tattoo@gmail.com</a>
                    ...
                    <div className="footer__social">
                        ...
                        <img src={facebook} alt="us twitter"className="facebook" />
